      ...
      <div className="cp-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="cp-field">
            ...
            <div className="cp-wrap">
              <Anchor.Input type={showNew ? "text" : "password"} ui="auth.change-password.new" id="doctor-cp-new" className={`cp-input${fieldErrors.newPassword ? " err" : ""}`} placeholder="Choose a strong password" value={newPassword} onChange={e => { setNewPassword(e.target.value); setFieldErrors(f => ({...f, newPassword: ""})); }} autoComplete="new-password" />
          ...
          <div className="cp-field">
            ...
            <div className="cp-wrap">
              <Anchor.Input type={showConfirm ? "text" : "password"} ui="auth.change-password.confirm" id="doctor-cp-confirm" className={`cp-input${fieldErrors.confirmPassword ? " err" : ""}`} placeholder="Repeat your new password" value={confirmPassword} onChange={e => { setConfirmPassword(e.target.value); setFieldErrors(f => ({...f, confirmPassword: ""})); }} autoComplete="new-password" />
